...
## //6.4. Options affecting specific writers
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --html-q-tags               | ::: {#cb120 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | html-q-tags: true                 |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --ascii                     | ::: {#cb122 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | ascii: true                       |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --reference-links           | ::: {#cb124 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | reference-links: true             |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --reference-location block  | ::: {#cb126 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | reference-location: block         |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --markdown-headings atx     | ::: {#cb128 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | markdown-headings: atx            |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --list-tables               | ::: {#cb130 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | list-tables: true                 |
|                                 | ```                               |
|                                 | :::                               |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --number-sections           | ::: {#cb134 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | number-sections: true             |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --number-offset=1,4         | ::: {#cb136 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | number-offset: \[1,4\]            |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --listings                  | ::: {#cb138 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | listings: true                    |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --incremental               | ::: {#cb140 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | incremental: true                 |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --slide-level 2             | ::: {#cb142 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | slide-level: 2                    |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --section-divs              | ::: {#cb144 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | section-divs: true                |
|                                 | ```                               |
|                                 | :::                               |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --id-prefix ch1             | ::: {#cb148 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | identifier-prefix: ch1            |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --title-prefix MySite       | ::: {#cb150 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | title-prefix: MySite              |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --css styles/screen.css  \  | ::: {#cb152 .sourceCode}          |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --reference-doc my.docx     | ::: {#cb154 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --epub-title-page=false     | ::: {#cb158 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | epub-title-page: false            |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --epub-metadata meta.xml    | ::: {#cb160 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | epub-metadata: meta.xml           |
|                                 | ```                               |
|                                 | :::                               |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --split-level 2             | ::: {#cb164 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | split-level: 2                    |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --chunk-template="%i.html"  | ::: {#cb166 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | chunk-template: "%i.html"         |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --epub-subdirectory=""      | ::: {#cb168 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | epub-subdirectory: ''             |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --ipynb-output best         | ::: {#cb170 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | ipynb-output: best                |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --pdf-engine xelatex        | ::: {#cb172 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | pdf-engine: xelatex               |
|                                 | ```                               |
|                                 | :::                               |
...
## //6.5. Citation rendering

+---------------------------------+-----------------------------------+
| command line                    | defaults file                     |
+:================================+:==================================+
|     --citeproc                  | ::: {#cb177 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | citeproc: true                    |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --bibliography logic.bib    | ::: {#cb179 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | bibliography: logic.bib           |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --csl ieee.csl              | ::: {#cb181 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | csl: ieee.csl                     |
|                                 | ```                               |
|                                 | :::                               |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --natbib                    | ::: {#cb185 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | cite-method: natbib               |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --biblatex                  | ::: {#cb187 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
...
## //6.6. Math rendering in HTML

+---------------------------------+-----------------------------------+
| command line                    | defaults file                     |
+:================================+:==================================+
|     --mathjax                   | ::: {#cb189 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | html-math-method:                 |
|                                 |   method: mathjax                 |
|                                 | ```                               |
...
## //6.7. Options for wrapper scripts

+---------------------------------+-----------------------------------+
| command line                    | defaults file                     |
+:================================+:==================================+
|     --dump-args                 | ::: {#cb199 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | dump-args: true                   |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --ignore-args               | ::: {#cb201 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | ignore-args: true                 |
|                                 | ```                               |
|                                 | :::                               |
...
### //7.2.5. Variables for HTML slides
...
### //7.2.6. Variables for Beamer slides
...
### //7.2.7. Variables for PowerPoint
...
#### //7.2.8.5. BibLaTeX Bibliographies
...
### //7.2.10. Variables for `wkhtmltopdf`
...
### //7.2.11. Variables for man pages
...
### //7.2.14. Variables set automatically
...
## //8.2. Headings and sections

#### //8.2.1. Extension: `auto_identifiers`
...
#### //8.2.2. Extension: `ascii_identifiers`

Causes the identifiers produced by `auto_identifiers` to be pure ASCII.
Accents are stripped off of accented Latin letters, and non-Latin
letters are omitted.

#### //8.2.3. Extension: `gfm_auto_identifiers`
...
## //8.5. Literate Haskell support

#### //8.5.1. Extension: `literate_haskell`
...
#### //8.6.01. Extension: `empty_paragraphs`
...
#### //8.6.02. Extension: `native_numbering`
...
#### //8.6.05. Extension: `styles` {#ext-styles}
...
#### //8.6.08. Extension: `citations` {#org-citations}
...
#### //8.6.09. Extension: `fancy_lists` {#org-fancy-lists}
...
#### //8.6.10. Extension: `element_citations`
...
#### //9.2.1. Extension: `escaped_line_breaks`
...
#### //9.3.2.1. Extension: `blank_before_header`
...
#### //9.3.2.2. Extension: `space_in_atx_header`
...
#### //9.3.3.2. Extension: `implicit_header_references`
...
#### //9.4.1. Extension: `blank_before_blockquote`
...
## //9.5. Verbatim (code) blocks

### //9.3.5.1. Indented code blocks
...
### //9.3.5.2. Fenced code blocks

#### //9.3.5.2.1. Extension: `fenced_code_blocks`
...
#### //9.3.5.2.2. Extension: `backtick_code_blocks`

Same as `fenced_code_blocks`, but uses backticks (`` ` ``) instead of
tildes (`~`).

#### //9.3.5.2.3. Extension: `fenced_code_attributes`
...
### //9.7.2. Block content in list items
...
#### //9.7.3.1. Extension: `fancy_lists` {#extension-fancy_lists}
...
### //9.7.4. Definition lists

#### //9.7.4.1. Extension: `definition_lists`
...
extensions.[^2^](#fn2){#fnref2 .footnote-ref role="doc-noteref"}
...
### //9.7.5. Numbered example lists

#### //9.7.5.1. Extension: `example_lists`
...
#### //9.9.1. Extension: `table_captions`
...
line below it:[^3^](#fn3){#fnref3 .footnote-ref role="doc-noteref"}
...
#### //9.9.3. Extension: `multiline_tables`
...
## //9.10. Metadata blocks

#### //9.10.1. Extension: `pandoc_title_block`
...
#### //9.10.2. Extension: `yaml_metadata_block`
...
#### //9.11.1. Extension: `all_symbols_escapable`
...
#### //9.12.1.1. Extension: `intraword_underscores`
...
### //9.12.3. Superscripts and subscripts

#### //9.12.3.1. Extension: `superscript`, `subscript`
...
#### //9.12.4.1. Extension: `inline_code_attributes`
...
#### //9.13.1. Extension: `tex_math_dollars`
...
#### //9.14.2. Extension: `markdown_in_html_blocks`
...
### //9.14.5 Generic raw attribute

#### //9.14.5.1. Extension: `raw_attribute`
...
#### //9.16.3.1. Extension: `shortcut_reference_links`
...
#### //9.17.1. Extension: `implicit_figures`
...
#### //9.17.2. Extension: `link_attributes`
...
#### //9.18.2. Extension: `bracketed_spans`
...
## //9.20. Citation syntax

#### //9.20.1. Extension: `citations` {#extension-citations}
...
#### //9.21.01. Extension: `rebase_relative_paths`
...
#### //9.21.05. Extension: `angle_brackets_escapable`
...
#### //9.21.06. Extension: `lists_without_preceding_blankline`

Allow a list to occur right after a paragraph, with no intervening blank
space.

#### //9.21.07. Extension: `four_space_rule`
...
#### //9.21.08. Extension: `spaced_reference_links`
...
#### //9.21.09. Extension: `hard_line_breaks`

Causes all newlines within a paragraph to be interpreted as hard line
breaks instead of spaces.

#### //9.21.10. Extension: `ignore_line_breaks`
...
#### //9.21.11. Extension: `east_asian_line_breaks`
...
#### //9.21.12. Extension: `emoji`

Parses textual emojis like `:smile:` as Unicode emoticons.

#### //9.21.13. Extension: `tex_math_gfm`
...
#### //9.21.14. Extension: `tex_math_single_backslash`
...
#### //9.21.15. Extension: `tex_math_double_backslash`

Causes anything between `\\(` and `\\)` to be interpreted as inline TeX
math, and anything between `\\[` and `\\]` to be interpreted as display
TeX math.

#### //9.21.16. Extension: `markdown_attribute`
...
#### //9.21.17. Extension: `mmd_title_block`
...
#### //9.21.18. Extension: `abbreviations`
...
#### //9.21.20. Extension: `autolink_bare_uris`

Makes all absolute URIs into links, even when not surrounded by pointy
braces `<...>`.

#### //9.21.21. Extension: `mmd_link_attributes`
...
#### //9.21.22. Extension: `mmd_header_identifiers`
...
#### //9.21.23. Extension: `compact_definition_lists`
...
#### //9.21.26. Extension: `short_subsuperscripts`
...
#### //9.21.27. Extension: `wikilinks_title_after_pipe`
...
## //10.1. Specifying bibliographic data
...
### //10.1.1. Capitalization in titles
...
### //10.1.2. Conference Papers, Published vs. Unpublished
...
## //10.2. Specifying a citation style
...
## //10.4. Placement of the bibliography
...
## //10.5. Including uncited items in the bibliography
...
## //10.6. Other relevant metadata fields
...
## //11.1. Structuring the slide show
...
### //11.1.1. PowerPoint layout choice
...
### //11.6.1. Additional columns attributes in beamer
...
## //11.7. Frame attributes in beamer
...
#### //11.8.1.1 `parallaxBackgroundImage` (reveal.js)
...
### //11.8.2. On individual slides (reveal.js, pptx)
...
### //11.8.3. On the title slide (reveal.js, pptx)
...
# /19. Accessible PDFs and PDF archiving standards
...
# /20. Running pandoc as a web server
...
# /21. Running pandoc as a Lua interpreter
...
2.  ::: {#fn2}
    ...
    Wheeler](https://justatheory.com/2009/02/modest-markdown-proposal/).[↩︎](#fnref2){.footnote-back
    role="doc-backlink"}
    :::
