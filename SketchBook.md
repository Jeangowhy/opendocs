...
15. Aaron Blaise 动漫角色表情 https://www.bilibili.com/video/BV1sq4y1A7zQ
...
铅笔 14B 相当中炭黑度。手感上，炭笔比铅摩擦力更大，铅笔的石墨成分则顺滑得多。
...
纸张是除了笔之外最重要的材料，一般使用正面绘画，比背面光滑。纸厂加工时正面向上，切割时从上往下压，
可以利用纸张边缘的弯曲方向来判断纸张正反面。一般练习使用 16 开（稍大于 A4 尺寸）或者 8 开即可。
平时做速写练习也只可以使用更便携的 A5、A6 速写纸。
...
排线层数控制在在 2、3 层以内，避免画面变油腻（肌理丢失）。排线应该一遍、一遍地进行，不要一出现空隙
就来回蹭，这样会将画面搞得很脏。应该排完一遍后，再根据需要重新排另一遍，修复缺陷部分。如果需要
使用多种铅笔，则保证硬铅覆盖软铅的顺序。硬铅更容易磨平纸面，产生反光问题。特别是普通打印纸，
因为其含有大量滑石粉，一般只在练习线条时使用。如果使用书写纸，一般会有一面较光滑（滑石粉），
比较难绘画出层次，应该使用粗糙面，或者尽量使用素描纸。
...
当前主流数字绘画工具有数位板、数位屏（较昂贵）。还有数位屏一体机，因为绑定主机，所以不如数位屏灵活。
...
为了更便于操作，有条件可以配置无线遥控器，例如 TourBox Elite（小贵），这是一款可深度自定义软件控制器。
...
2. PTH-660 尺寸（33.8 x 21.9 x 8cm，绘画区 224x148）相当 A4 纸。
...
1. Airi Pan 绘画教程 Photobashing Basics https://www.bilibili.com/video/BV1F34y1X7py?p=25
2. Airi Pan 绘画教程 Speed Painting https://www.bilibili.com/video/BV1F34y1X7py?p=46
3. 测评丨TourBox Elite 从难用到真香?! https://www.bilibili.com/video/BV1CR4y197kU
4. 测试工具 Digiinfo https://learn.microsoft.com/zh-cn/windows-hardware/design/component-guidelines/simultaneous-pen-and-touch-validation
...
最容易画出流畅的线条，因此可以花更多时间去做腕灵活性提升训练。
...
为了让明暗关系有序递进，画线条时就需要慢慢来，对于过度平缓的位置可能需要十数次的反复处理才能
让明暗关系正确地过度好。如果，一上来就浓重地涂抹，可能就破坏了明暗关系。
...
王东晟老师的《插画师十二种武器》囊括铅笔、彩铅、水彩、秀丽笔、针管笔、彩色签字笔、粉笔、马克笔、圆珠笔、墨水、丙烯、版刻，以及 iPad 和 Apple Pencil 数字手绘，根据每种工具总结出相应的运笔手法或使用技巧，零基础开始帮你筑基，打开你的创作思路，提升你的绘画水平。
