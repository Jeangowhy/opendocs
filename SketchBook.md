...
1. 素描工具：铅笔（硬软差别，硬铅覆盖软铅）、橡皮、棉球或面纸（擦除或模糊）；
2. 素描理论：比例关系、明暗关系、主次关系、虚实关系；
3. 基础练习：正确握笔姿势，基本线条、排线；
4. 几何体练习：通过规则的几何体（用于简化复杂对象的模型）练习形准（轮廓线）、光线、透视等基础；
...
盲画这种能力和打字时的盲打一样，可以提高协调能力，特别是对于使用数位板绘画的场合。通过盲画练习，
还可能发现潜在的握笔姿势问题，这些难以发现的错误可能极大地影响入门的线条练习。
...
https://www.bilibili.com/video/BV1KN4y1X7XU/
https://www.bilibili.com/video/BV1Ud4y1e7o3?p=6
