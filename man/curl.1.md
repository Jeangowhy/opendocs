...
# /OPTIONS
   ...
   -d, --data @foobar. When --data is told to read from a file like
   ...
   commas. Port numbers may also optionally be given as :<port-number> 
   ...
   following redirections too much. By default, the limit is set to
   50 redirections. Set this option to -1 to make it unlimited.
   ...
   on being able to disable potentially dangerous protocols, without
   ...
   redirect_url   When an HTTP request was made without -L,
       ...
       redir is met), this variable will show the actual
