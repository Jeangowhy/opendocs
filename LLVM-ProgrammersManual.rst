...
You are also encouraged to take a look at the `LLVM Coding Standards
<https://llvm.org/docs/CodingStandards.html>` guide which focuses on how to 
write maintainable code more than where to put your curly braces.
